 ...
 */
package sc2toolkit.common.version.impl;
...
import sc2toolkit.common.annotation.HiddenProperty;
import sc2toolkit.common.version.model.IBean;
...
public class Bean implements IBean {
   ...
   * <p>
   * No-arg constructor required by some implementation of
   * {@link JAXB#unmarshal(java.io.Reader, Class)}.
   * </p>
   */
  protected Bean() {
  }
   ...
   * <p>
   * <p>
   * This default bean cloning implementation is "very" slow, it even marshals
   * and unmarshals primitive type values (like <code>int</code> or
   * <code>boolean</code>) and immutable objects (like {@link String}) which
   * otherwise would not be necessary. But works for all beans without
   * modification, and does not require modification when a bean is modified or
   * extended with new fields later on (<i>resilient</i> to changes).
   * </p>
   * <p>
   * Beans that are frequently cloned should override this method and implement
   * a custom cloning. A custom cloning (which copies the fields) can be even
   * 1000 times faster than this!
   * </p>
   *
  ...
  public void buildDevString(final StringBuilder b) {
    ...
    for (final Method m : getClass().getMethods()) {
      ...
      try {
        ...
        LOG.log(Level.SEVERE, "Could not call method: " + getClass().getSimpleName() + "." + name, e);
      }
      b.append("; ");
    }
