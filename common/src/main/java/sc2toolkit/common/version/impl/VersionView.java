...
import sc2toolkit.common.version.model.IVersionView;

/**
 * A class to represent a version with any number of parts.
 * <p>
 * <p>
 * Instances are IMMUTABLE, but the array passed in the constructor
 * {@link #VersionView(int...)} is not cloned!
 * </p>
 *
...
public class VersionView implements IVersionView {
   ...
   * @return the version view parsed from the specified string, or
   *         <code>null</code> if the specified string is not a valid version
   *         string
   */
