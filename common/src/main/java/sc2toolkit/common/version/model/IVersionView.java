 ...
 * <p>
 * <p>
 * {@link #equals(Object)}, {@link #hashCode()} and {@link #toString()} are
 * properly overridden.
 * </p>
 * <p>
 * <p>
 * Instances can be acquired by {@link IFactory#newVersionView(int...)} or
 * {@link IFactory#newVersionView(String)}.
 * </p>
 *
...
public interface IVersionView extends Comparable< IVersionView> {
   ...
   * <p>
   * <p>
   * If strict mode is not enabled and the common parts of the version views are
   * equal, the result will be 0.<br>
   * If strict mode is enabled and the common parts of the version views are
   * equal, the version view with more parts will be the greater.
   * </p>
   * <p>
   * Examples:
   ...
   * @return a negative number if this version view is less than the specified
   *         other version, 0 if equals to, and a positive number if this
   *         version view is greater than the specified other version
   *
  ...
  /**
   * Properly overridden to check if the number of parts and the parts are
   * equal.
   */
  @Override
   ...
   * {@link #equals(Object)}, {@link IVersionView}'s can be used in hash-based
   * structures.
   */
  @Override
  int hashCode();
  ...
  /**
   * Properly overridden to return the string representation of this version
   * view.
   */
  @Override
  String toString();
