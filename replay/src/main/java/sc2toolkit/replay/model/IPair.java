...
public interface IPair< T1, T2> {
  ...
  /**
   * Returns <code>true</code> if both values of the pairs in this object and in
   * the other one are equal.
   * <p>
   * <p>
   * If a value is <code>null</code>, then the value in the other pair must also
   * be <code>null</code> in order to be equal.
   * </p>
   */
  @Override
