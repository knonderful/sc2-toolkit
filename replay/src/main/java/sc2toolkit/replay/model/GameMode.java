...
public enum GameMode {
   ...
   * @param attrValue game mode value used for for
   *                  {@link AttributesEvents#A_GAME_MODE}
   */
   ...
   * @return the game mode for the specified raw value; or {@link #UNKNOWN} if
   *         no game mode is found for the specified raw value
   */
