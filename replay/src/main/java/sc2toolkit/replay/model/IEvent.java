 ...
 */
public interface IEvent extends IStructView {
   ...
   *                required to decode / translate field values
   ...
   * Includes all non-default fields from the underlying struct which has a
   * non-null value, recursively.
   *
