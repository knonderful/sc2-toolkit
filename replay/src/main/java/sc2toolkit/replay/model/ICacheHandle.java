...
public interface ICacheHandle {
   ...
   *
   * @return the content of the cache handle if it is a <i>standard data</i>;
   *         <code>null</code> otherwise
   */
  String getStandardData();

  /**
   * Returns the file name (with extension), and with the region code in square
   * brackets. Also if the dependency is a <i>standard data</i>, it will be
   ...
   * </p>
   *
   * @return a string with the file name, extension, region code and optionally
   *         the content if the cache handle is a <i>standard data</i>
   */
  @Override
  String toString();
