...
public interface IBitArray {
   ...
   *
   * @param index index of the bit to test, must be in the range of 0..count
   *              (exclusive)
   * @return true if the bit at the specified index is <code>1</code>; false
   *         otherwise
   *
   * @since 1.3
   *
  ...
  /**
   * Returns the hex string representation of the bits postpended with the count
   * in parenthesis.
   *
   * @return the hex string representation of the bits postpended with the count
   *         in parenthesis
   */
  @Override
  String toString();
