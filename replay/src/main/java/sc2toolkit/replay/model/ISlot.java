...
public interface ISlot extends IStructView {
  ...
  /**
   * Tandem leader user id (in case of Archon mode games). Only present in
   * 3.0.0.
   */
  String F_TANDEM_LEADER_USER_ID = "tandemLeaderUserId";

  /**
   * Tandem leader user id (in case of Archon mode games). Only present from
   * 3.1.0.
   */
  ...
  /**
   * Returns the toon handle. It's in the form required by
   * {@link IFactory#newToon(String)}.
   *
