...
public interface IGameDescription extends IStructView {
   ...
   * Present only up to base build 23260, missing starting from 24674 (replaced
   * by {@link #P_COMPETITIVE}).
   *
   * @see #P_COMPETITIVE
   */
  ...
  /**
   * Returns the competitive field value. Competitive means either ranked or
   * unranked game.<br>
   * Present in base versions from 24674, replaces {@link #P_RANKED}.
   *
