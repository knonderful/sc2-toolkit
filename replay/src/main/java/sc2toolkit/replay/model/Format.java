...
public enum Format {
   ...
   * @param attrValue format value used for
   *                  {@link AttributesEvents#A_PARTIES_PREMADE}
   */
   ...
   * @return the {@link Format} for the specified attribute value; or
   *         {@link Format#CUSTOM} if no matching format found
   */
