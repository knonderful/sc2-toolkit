...
public interface IAttributesEvents extends IStructView {
   ...
   * <p>
   * The source structure of the attributes events contains scopes as integer
   * maps (where keys are integers). This is not display friendly (user
   * friendly). This method creates / converts those integer maps to string maps
   * (where the keys are informative strings).
   * </p>
   *
