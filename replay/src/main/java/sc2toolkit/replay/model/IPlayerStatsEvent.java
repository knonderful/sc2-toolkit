 ...
 * <p>
 * <p>
 * This event contains only 1 field ({@link #F_STATS}) which is a structure.
 * Everything else is inside of this stats structure field, so for simplicity
 * and efficiency everything else is provided relative to that.
 * </p>
 *
