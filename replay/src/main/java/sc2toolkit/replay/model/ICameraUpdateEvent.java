...
public interface ICameraUpdateEvent extends IEvent {
  ...
  /**
   * Returns the pitch (angle in the vertical plane, vertical elevation) in
   * degrees as float.
   *
   * @return the pitch (angle in the vertical plane, vertical elevation) in
   *         degrees as float
   *
   * @see #getPitch()
   */
   ...
   */
  ICamTargetPoint getTargetPoint();
