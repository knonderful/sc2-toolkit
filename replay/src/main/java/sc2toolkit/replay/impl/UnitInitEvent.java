...
/**
 * Unit init tracker event: appears for units under construction. When complete
 * a {@link UnitDoneEvent} appears with the same unit tag.
 *
...
public class UnitInitEvent extends BaseUnitEvent implements IUnitInitEvent {
   ...
   *                  resolution differences in tracker positions in different
   *                  versions
   */
