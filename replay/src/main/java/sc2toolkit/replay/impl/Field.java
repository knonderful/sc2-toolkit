 ...
 * <p>
 * <p>
 * Fields used for structures (<code>"_struct"</code>) have/use the {@link #tag}
 * attribute, fields used for choices ( <code>"_choice"</code>) omit the
 * {@link #tag}.
 * </p>
 * <p>
 * <p>
...
public class Field {
   ...
   * For optimization purposes: this check is performed many times, and the
