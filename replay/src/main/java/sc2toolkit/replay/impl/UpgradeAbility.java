...
import sc2toolkit.replay.model.IUpgradeAbility;

/**
 * Describes a StarCraft II unit upgrade ability.
 * <p>
 * <p>
 * This is a "virtual" ability. The ability id will be the id of the to whom the
 * command is given.
 * </p>
 *
...
public class UpgradeAbility extends Ability implements IUpgradeAbility {
   ...
   *
   * @param id id of the upgrade ability, it is the id of the unit to whom the
   *           command is given
   */
