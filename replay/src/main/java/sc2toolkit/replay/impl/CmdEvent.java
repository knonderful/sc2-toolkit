...
import sc2toolkit.replay.model.CmdFlag;
import sc2toolkit.replay.model.ICmdEvent;
...
public class CmdEvent extends Event implements ICmdEvent {
	...
	private final CmdTargetPoint targetPoint;
		...
		if ( data == null ) {
			...
			switch ( data.value1 ) {
				case "TargetUnit" :
					...
					targetPoint = new CmdTargetPoint( targetUnit.getSnapshotPoint() );
					break;
				case "TargetPoint" :
					targetUnit = null;
					@SuppressWarnings( "unchecked" )
					final Map< String, Object > tpStruct = (Map< String, Object >) data.value2;
					targetPoint = new CmdTargetPoint( tpStruct );
					break;
				case "Data" :
					// TODO
	...
	@Override
	public CmdTargetPoint getTargetPoint() {
		return targetPoint;
	}
