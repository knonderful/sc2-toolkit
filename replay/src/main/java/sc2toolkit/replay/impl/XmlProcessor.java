...
public class XmlProcessor {
  ...
  /**
   * Returns the first element specified by its tag name, in the scope of the
   * document element.
   *
   * @param tagName tag name of the element to be returned
   * @return the first element specified by its tag name or <code>null</code> if
   *         no such element exists in the document elemept scope
   *
   ...
   * <p>
   * <p>
   * The scope means the element to look for and return must be a descendant of
   * the scope element.
   * </p>
   *
   ...
   * @param tagName      tag name of the element to be returned
   * @return the first element specified by its tag name or <code>null</code> if
   *         no such element exists in the specified scope
   */
