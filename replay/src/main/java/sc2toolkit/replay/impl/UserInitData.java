...
import sc2toolkit.replay.model.IUserInitData;
...
public class UserInitData extends StructView implements IUserInitData {
  ...
  /**
   * Associated player id for this user init data (in
   * {@link Details#getPlayerList()})
   */
   ...
   * @param playerId associated player id for this slot (in
   *                 {@link Details#getPlayerList()})
   */
