...
public class BR {
   ...
   * @return the resource locator or <code>null</code> if no resource found for
   *         the specified name
   */
   ...
   *
   * @param name name of the resource find
   * @return an input stream to read from the specified resource or
   *         <code>null</code> if no resource found for the specified name
   */
