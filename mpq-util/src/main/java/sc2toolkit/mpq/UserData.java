 ...
 * <p>
 * <p>
 * The second version of the MoPaQ format, first used in Burning Crusade,
 * features a mechanism to store some amount of data outside the archive proper,
 * though the reason for this mechanism is not known. This is implemented by
 * means of a shunt block that precedes the archive itself. The format of this
 * block is as follows (see below):
 * </p>
 * <p>
 * <p>
 * When Storm encounters this block in its search for the archive header, it
 * saves the location of the shunt block and resumes its search for the archive
 * header at the offset specified in the shunt.<br>
 * <br>
 * Blizzard-generated archives place the shunt at the beginning of the file, and
 * begin the archive itself at the next 512-byte boundary after the end of the
 * shunt block.
 * </p>
 * <p>
 * <p>
