...
public class AlgorithmUtil {
   ...
   * <p>
   * <p>
   * The decryption will wrap the data with a byte buffer, and decrypt inside
   * that (it shares the original byte buffer).
   *
  ...
  /**
   * Decompresses a block which was compressed using the multi compression
   * method.
   *
   ...
   * @param destPos position in the destination buffer to copy the decompressed
   *                data
   * @throws InvalidMpqArchiveException if unsupported compression is found or
   *                                    the decompression of the block fails
   */
